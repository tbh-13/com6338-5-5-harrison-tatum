...
function runTests() {
  ...
  describe("Hamburger Menu", function() {
    ...
    const pressEscape = () => {
      ...
      body.dispatchEvent(new KeyboardEvent('keyup', event))
      document.dispatchEvent(new KeyboardEvent('keydown', event))
      body.dispatchEvent(new KeyboardEvent('keydown', event))
      document.dispatchEvent(new KeyboardEvent('keypress', event))
      body.dispatchEvent(new KeyboardEvent('keypress', event))
    }
    before(() => {
